...
admin=["ueb75b68a3137c28a4854aea891706c97"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner. ID Line : StarKing",
    "lang":"JP",
    "comment":"Owner. ID Line : Setarkeng",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
            ...
            elif msg.text in ["TCK","TheCyberKicker"]:
                    ki.sendText(msg.to,"We are The Best")
#-----------------------------------------------

            elif msg.text in ["About","Own"]:
				ki.sendText(msg.to,"Owner : line.me/ti/p/~setarkeng")
...
#------------------------------------------------------------------
    ...
    #-------------Fungsi Tagall User Finish By :ᴋᴀʀɪᴀ -------------#
            ...
            elif msg.text in ["Kontol","KONTOL","kontol"]:
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by StarKing")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by StarKing")
						print "Like"
					except:
							pass
				else:
